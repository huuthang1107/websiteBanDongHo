                      ...
                      <span class="table-add float-right mb-3 mr-2"><a href="#!" class="text-success"> <i
                                        ...
                                        <table id="bang1" class="table table-bordered table-responsive-md table-striped text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true"><img width="50px" height="50px"
                                                                                                  src="../assets/img/2_LTP-E165D-1ADF.png" alt=""></td>
                                                <td class="pt-3-half" contenteditable="true">Sage Rodriguez</td>
                                                <td class="pt-3-half" contenteditable="true">Doxa</td>
                                                <td class="pt-3-half" contenteditable="true">11.000.000</td>
                                                <td class="pt-3-half" contenteditable="true">12.000.000đ</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true"> <img width="50px" height="50px"
                                                                                                   src="../assets/img/4_OR-LOVE-399x399.png" alt="">
                                                </td>
                                                <td class="pt-3-half" contenteditable="true">Philip Chaney</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true"> <img width="50px" height="50px"
                                                                                                   src="../assets/img/5_OR-STAR-399x399.png" alt="">
                                                </td>
                                                <td class="pt-3-half" contenteditable="true">Mason Porter</td>
                                                <td class="pt-3-half" contenteditable="true">Doxa</td>
                                                <td class="pt-3-half" contenteditable="true">11.000.000</td>
                                                <td class="pt-3-half" contenteditable="true">12.000.000đ</td>
                                                <td class="pt-3-half" contenteditable="true">2</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                <td class="pt-3-half" contenteditable="true">A5</td>
                                                <td class="pt-3-half" contenteditable="true"> <img width="50px" height="50px"
                                                                                                   src="../assets/img/7_OR-2-399x399.png" alt="">
                                                </td>
                                                <td class="pt-3-half" contenteditable="true">Mason Porter</td>
                                                <td class="pt-3-half" contenteditable="true">Doxa</td>
                                                <td class="pt-3-half" contenteditable="true">11.000.000</td>
