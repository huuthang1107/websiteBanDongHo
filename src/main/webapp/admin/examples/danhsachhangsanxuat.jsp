        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" style="color:#ff6600 ;" href="danhsachhangsanxuat.html">Danh sách hãng sản xuất</a>
                    <a style="color:black  ;" href="themhangsanxuat.html">Thêm hãng sản xuất</a>
                </div>
                            ...
                            <div class="card">
                                    ...
                                    <div id="table" class="table-editable">
                                        ...
                                        <table id="bang1" class="table table-bordered table-responsive-md table-striped text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Doxa</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Casio</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Omega</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Seiko</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Citizen</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">DainielWellington</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Saga</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Fouette</td>
