        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" style="color:#ff6600 ;" href="danhsachtheloai.html">Danh sách danh mục</a>
                    <a style="color:black  ;" href="themtheloai.html">Thêm danh mục</a>
                </div>
                            ...
                            <div class="card">
                                    ...
                                    <div id="table" class="table-editable">
                                        ...
                                        <table id="bang1" class="table table-bordered table-responsive-md table-striped text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Đồng hồ nam</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Đồng hồ nữ</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Đồng hồ cặp đôi</td>
                                                <td class="pt-3-half" contenteditable="true">27/7/2020</td>
