        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a style="color:black  ;" href="themtaikhoan.html">Thêm tài khoản</a>
                </div>
                            ...
                            <div class="card">
                                    ...
                                    <div id="table" class="table-editable">
                                        ...
                                        <table id="bang1" class="table table-bordered table-responsive-md table-striped text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Có</td>
                                                <td class="pt-3-half" contenteditable="true"><div class="center">
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">abv@gmail.com</td>
                                                <td class="pt-3-half" contenteditable="true">123456</td>
                                                <td class="pt-3-half" contenteditable="true">Không</td>
                                                <td class="pt-3-half" contenteditable="true"><div class="center">
                                                    <input type="checkbox" name="">
